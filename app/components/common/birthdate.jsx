...
const Birthdate = ({ typingLoginSignupUserAction, typingLoginSignupUserState, label }) => {
  ...
  return (
    <div className={cx('form-birthdate-container')}>
      ...
      <div className={cx('input-birthdate-container')}>
        <SelectField floatingLabelText="Année" className={cx('birthdate-year')} id="birthdate-year" name="birthdateYear" onChange={handleSelectDateChange('birthdateYear')} value={typingLoginSignupUserState.birthdateYear} >
